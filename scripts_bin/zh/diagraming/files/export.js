var Export = {
    ...
    getMarkerRect: {
        getTriRect: function(i, d, j, c) {
            var b, f, e, g, a;
            b = Math.PI / 2 - i;
            outer_t = c / Math.tan(b / 2),
            e = c / Math.sin(i);
            g = d + outer_t * 2,
            a = j + c + e;
            return {
        ...
        getArrowRect: function(i, d, j, c) {
            var b, f, e, g, a;
            f = c * Math.sin(i),
            outer_t = c * Math.cos(i),
            e = c / Math.sin(i);
            g = d + outer_t * 2,
            a = j + f + e;
            return {
    ...
    getMarkerPoint: function(k, j, g, e, b) {
        var c = g.w + g.x;
        if (e == "broken") {
            if (b) {
                if (k.x == j.x) {
                    temp = k.y < j.y ? k.y + c : k.y - c;
                    temp = k.y < j.y ? (temp > j.y ? j.y - 1 : temp) : (temp < j.y ? j.y + 1 : temp);
                    return {
                        x: k.x,
                        y: temp
                    }
                } else {
                    temp = k.x < j.x ? k.x + c : k.x - c;
                    temp = k.x < j.x ? (temp > j.x ? j.x - 1 : temp) : (temp < j.x ? j.x + 1 : temp);
                    return {
                        x: temp,
                        y: k.y
                    }
                ...
                if (k.x == j.x) {
                    temp = j.y < k.y ? j.y + c : j.y - c;
                    temp = j.y < k.y ? (temp > k.y ? k.y - 1 : temp) : (temp < k.y ? k.y + 1 : temp);
                    return {
                        x: k.x,
                        y: temp
                    }
                } else {
                    temp = j.x < k.x ? j.x + c : j.x - c;
                    temp = j.x < k.x ? (temp > k.x ? k.x - 1 : temp) : (temp < k.x ? k.x + 1 : temp);
                    return {
                        x: temp,
                        y: k.y
                    }
            ...
            if (e == "normal") {
                var i = j.x - k.x
                  , f = j.y - k.y;
                var d = Math.sqrt(Math.pow(i, 2) + Math.pow(f, 2));
                var a = c * i / d
                  , h = c * f / d;
                if (b) {
                    return {
    ...
    andriod_icons: {
        ...
        alert1: {
            width: 24,
            height: 24,
            path: "M12 2c-5.52 0-10 4.48-10 10s4.48 10 10 10 10-4.48 10-10-4.48-10-10-10zm1 15h-2v-2h2v2zm0-4h-2v-6h2v6z",
            color: "#000"
        },
        alert2: {
            width: 24,
            height: 24,
            path: "M12 2C6.48 2,2 6.48 2,12c0 5.52 4.48 10 10 10c5.52 0 10-4.48 10-10C22 6.48 17.52 2 12 2z M13 17h-2v-2h2V17zM13 13h-2V7h2V13z",
            color: "#E51C23"
        },
        alert3: {
            width: 24,
    ...
    ico: {
        ...
        priority: {
            path: "M3 15A12 12 0 0 1 15 3A12 12 0 1 1 3 15Z",
            x: 0,
            y: 0,
            width: 30,
            height: 30,
        ...
        flag: {
            ...
            boxW: 30,
            boxH: 30,
            color: ["#3D72A7", "#488F55", "#EA9A4B", "#A7443B", "#804E67", "#EDA600", "#41BEFD"]
        },
        arrow: {
            x: 0,
            y: 0,
            ...
            boxH: 30,
            color: "#5A9800",
            path: ["M15 3L3 14.613h7.2V27h9.6V14.613H27L15 3z", "M15 27l12-11.613h-7.2V3h-9.6v12.387H3L15 27z", "M3 15l11.614 12v-7.2H27v-9.6H14.614V3L3 15z", "M27 15L15.387 3v7.2H3v9.6h12.387V27L27 15z", "M3 15l5.807 12v-7.2H15v-9.6H8.807V3L3 15zM27 15L21.193 3v7.2H15v9.6h6.193V27L27 15z", "M15 3L3 8.807h7.2V15h9.6V8.807h7.202L15 3zM15 27l12-5.807h-7.199V15h-9.6v6.193H3L15 27z"]
        },
        ico38: {
            path: "M3 15A12 12 0 0 1 15 3A12 12 0 1 1 3 15ZM8 13L5 16L12 23L24 11L21 8L12 17L8 13Z",
            x: 0,
            y: 0,
            width: 30,
            height: 30,
        ...
        ico39: {
            path: "M3 15A12 12 0 0 1 15 3A12 12 0 1 1 3 15ZM8.64 10.76L12.88 15L8.64 19.24L10.76 21.36L15 17.12L19.24 21.37L21.36 19.24L17.12 15L21.37 10.76L19.24 8.64L15 12.88L10.76 8.64Z",
            x: 0,
            y: 0,
            width: 30,
            height: 30,
        ...
        ico40: {
            path: "M11 12h3.2v3H11V12z M15.8 12H19v3h-3.2V12z M20.6 12h3.2v3h-3.2V12z M6.2 21h3.2v3H6.2V21z M11 21h3.2v3H11V21z M15.8 21 H19v3h-3.2V21z M11 16.5h3.2v3H11V16.5z M15.8 16.5H19v3h-3.2V16.5z M20.6 16.5h3.2v3h-3.2V16.5z M6.2 16.5h3.2v3H6.2V16.5z M23.8 3 v1.5h-3.2V3H9.4v1.5H6.2V3H3v24h24V3H23.8z M25.4 25.5H4.6V9h20.8V25.5z",
            x: 0,
            y: 0,
            width: 30,
            height: 30,
        ...
        ico42: {
            path: "M26.512 22.418L17.409 4.805C16.817 3.658 15.937 3 14.995 3s-1.821 0.658-2.415 1.806L3.489 22.417 c-0.589 1.14-0.648 2.295-0.164 3.189C3.811 26.498 4.781 27 5.989 27h18.021c1.208 0 2.18-0.502 2.664-1.394 C27.16 24.712 27.1 23.558 26.512 22.418z M14.146 9.438c0-0.509 0.383-0.924 0.855-0.924c0.472 0 0.854 0.415 0.854 0.924v8.32 c0 0.51-0.383 0.924-0.854 0.924c-0.473 0-0.855-0.414-0.855-0.924V9.438z M15.001 24.231c-0.71 0-1.283-0.621-1.283-1.388 c0-0.765 0.573-1.386 1.283-1.386c0.709 0 1.282 0.621 1.282 1.386C16.283 23.61 15.71 24.231 15.001 24.231z",
            x: 0,
            y: 0,
            width: 30,
            height: 30,
        ...
        ico45: {
            path: "M15 3L7.583 27L27 12.167L3 12.167L22.416 27",
            x: 0,
            y: 0,
            width: 30,
            height: 30,
        ...
        ico50: {
            path: "M15.787 19.293v3.074h-1.43v-3.074c-0.418-0.252-0.715-0.689-0.715-1.215c0-0.787 0.642-1.428 1.43-1.428 c0.786 0 1.428 0.641 1.428 1.428C16.5 18.604 16.204 19.041 15.787 19.293z M22.215 8.571c0-3.947-3.197-7.143-7.143-7.143 S7.929 4.625 7.929 8.571v3h2.856v-3c0-2.367 1.918-4.286 4.287-4.286c2.363 0 4.283 1.918 4.283 4.286H22.215z M6.5 11.573V27 h17.145V11.571L6.5 11.573z",
            x: 0,
            y: 0,
            width: 30,
            height: 30,
        ...
        ico51: {
            path: "M4.411 5.957h21.187c0.376 0 0.742 0.081 1.081 0.235L15.004 19.811L3.33 6.192C3.667 6.037 4.033 5.957 4.411 5.957z M3 22.92V7.033c0-0.055 0.002-0.11 0.006-0.165l7.766 9.058l-7.68 7.681C3.033 23.384 3 23.158 3 22.92z M25.598 24.041H4.411 c-0.233 0-0.463-0.03-0.684-0.091l7.536-7.536l3.741 4.368l3.741-4.366l7.535 7.537c-0.224 0.059-0.449 0.091-0.683 0.091V24.041z M27 22.92c0 0.236-0.032 0.464-0.091 0.687l-7.679-7.681l7.765-9.058C26.999 6.924 27 6.979 27 7.033V22.92L27 22.92z",
            x: 0,
            y: 0,
            width: 30,
            height: 30,
        ...
        ico55: {
            path: "M20.25 3H9.75C8.513 3 7.5 4.013 7.5 5.25v19.5C7.5 25.987 8.513 27 9.75 27h10.5c1.237 0 2.25-1.013 2.25-2.25V5.25 C22.5 4.013 21.487 3 20.25 3z M12 4.125h6v0.75h-6V4.125z M15 25.5c-0.828 0-1.5-0.672-1.5-1.5s0.672-1.5 1.5-1.5 s1.5 0.672 1.5 1.5S15.828 25.5 15 25.5z M21 21H9V6h12V21z",
            x: 0,
            y: 0,
            width: 30,
            height: 30,
        ...
        ico56: {
            path: "M23.462 3H6.538C5.142 3 4 4.013 4 5.25v19.5C4 25.987 5.142 27 6.538 27h16.924C24.857 27 26 25.987 26 24.75V5.25 C26 4.013 24.857 3 23.462 3z M15 26.25c-0.468 0-0.846-0.336-0.846-0.75s0.378-0.75 0.846-0.75s0.846 0.336 0.846 0.75 S15.468 26.25 15 26.25z M22.614 24H7.385V6h15.229V24z",
            x: 0,
            y: 0,
            width: 30,
            height: 30,
        ...
        ico60: {
            path: "M4.817 15.205l1.407 1.407l-0.001 0.002l8.775 8.771L15 25.383l0.001 0.002l8.775-8.771l-0.001-0.002l1.407-1.407 c2.423-2.422 2.423-6.349 0-8.772c-2.424-2.423-6.353-2.423-8.775 0L15 7.839l-1.407-1.406c-2.423-2.423-6.352-2.423-8.775 0 C2.395 8.855 2.395 12.782 4.817 15.205z",
            x: 0,
            y: 0,
            width: 30,
            height: 30,
        ...
        ico61: {
            path: "M26.489 10.364l-2.37-2.369c-0.581-0.582-1.532-1.533-2.113-2.113l-2.37-2.37c-0.581-0.581-1.616-0.683-2.3-0.228 l-6.479 4.318c-0.684 0.457-0.943 1.431-0.575 2.166l1.652 3.304c0.05 0.101 0.109 0.208 0.173 0.321L3.75 21.75L3 27h4.5v-1.5h3v-3 h3v-3h3v-1.669c0.15 0.089 0.294 0.169 0.427 0.235l3.304 1.652c0.735 0.367 1.709 0.108 2.165-0.575l4.319-6.48 c0.456-0.684 0.354-1.719-0.228-2.299H26.489z M6.532 23.03L5.471 21.97l7.303-7.303l1.061 1.061L6.532 23.03L6.532 23.03z  M24.101 12.667c0 1.104-0.896 2-2 2s-2-0.896-2-2s0.896-2 2-2S24.101 11.563 24.101 12.667z",
            x: 0,
            y: 0,
            width: 30,
            height: 30,
        ...
        ico63: {
            path: "M26.122 8.115l-2.233 2.234L19.58 6.178l2.299-2.299c1.172-1.172 3.071-1.172 4.243 0 C27.293 5.048 27.293 6.943 26.122 8.115z M22.579 11.652L8.847 25.372L3 27l1.604-5.863L18.286 7.469L22.579 11.652z",
            x: 0,
            y: 0,
            width: 30,
            height: 30,
...
Export.svg = {
    draw2svg: function(J, aq, N, S, B, r) {
        var D, F, E, M, O, e, am, b, ab, aj, ad, av, s, v, t, C, j, m, L, ay, au, Y, ae, an, W, G, Q, H, z, P;
        var V = des.utils.getRelativePos(J.offset().left, J.offset().top, $("#canvas"));
        var ax = this.getTopicType(S)
          , y = B.key;
        var ag = des.utils.getExtendStyle(S);
        D = J.css2num("font-style");
        F = J.css2num("font-size");
        E = J.css2num("font-weight");
        M = J.css2num("font-family");
        O = J.css2num("color");
        e = J.css2num("text-align");
        am = J.find(".topic_text").width();
        b = J.find(".topic_text").height();
        ab = J.find(".topic_text").css2num("padding-top");
        aj = J.find(".topic_text").css2num("padding-left");
        ad = J.find(".topic_text").css2num("padding-right");
        av = J.find(".topic_text").css2num("padding-bottom");
        s = J.css2num("padding-top");
        v = J.css2num("padding-left");
        t = J.css2num("padding-right");
        C = J.css2num("padding-bottom");
        an = J.height() + s + C;
        W = J.width() + v + t;
        j = V.x - $("#canvas").width() / 2;
        m = V.y - $("#canvas").height() / 2;
        L = this.restoreXss(J.find(".topic_text").html()).split("<br>");
        ay = Export.getColor(ag.bgColor || B[ax].bgColor);
        au = J.css2num("border-color");
        Y = J.css2num("border-width");
        ae = this.getRadius(W, an);
        G = ag.lineWidth;
        Q = ag.lineColor;
        H = ag.lineType;
        z = ag.shape;
        ...
        var d;
        var l;
        var ai, Z, U, R = an / 2, ar;
        if (J.siblings(".tp_expand_box")[0]) {
            l = J.siblings(".tp_expand_box");
            if (z == "underline") {
                Z = an - 7,
                R = an + Math.ceil(G / 2)
            } else {
                Z = an / 2 - 7,
                R = an / 2 + Math.ceil(G / 2)
            }
            if (j < 0) {
                ai = -15,
                U = 0,
            ...
            c = [["M", U, R], ["l", ar, 0]];
            if (!J.siblings(".tp_expand_box.collapsed")[0]) {
                d = [["M", 7, 1], ["a", 6, 6, 0, 0, 0, -6, 6], ["a", 6, 6, 0, 1, 0, 6, -6], ["z"], ["M", 0, 7], ["a", 7, 7, 0, 0, 1, 7, -7], ["a", 7, 7, 0, 1, 1, -7, 7], ["z"], ["M", 3, 6], ["h", 8], ["v", 2], ["h", -8], ["v", -3], ["z"]]
            } else {
                d = [["M", 7, 1], ["a", 6, 6, 0, 0, 0, -6, 6], ["a", 6, 6, 0, 1, 0, 6, -6], ["z"], ["M", 0, 7], ["a", 7, 7, 0, 0, 1, 7, -7], ["a", 7, 7, 0, 1, 1, -7, 7], ["z"], ["M", 3, 6], ["h", 3], ["v", -3], ["h", 2], ["v", 3], ["h", 3], ["v", 2], ["h", -3], ["v", 3], ["h", -2], ["v", -3], ["h", -3], ["v", -2], ["z"]]
            }
        }
        var ao = aq.group().attr({
            transform: "translate(" + j + " " + m + ")"
        });
        var aa, ac;
        var at = [ae, ae, 0, 0, 1];
        if (z == "round") {
            aa = [["M", 0, an / 2], ["A", W / 2, an / 2, 0, 0, 1, W / 2, 0], ["A", W / 2, an / 2, 0, 1, 1, 0, an / 2], ["Z"]];
            ac = ao.path(aa)
        } else {
            if (z == "diamond") {
                aa = [["M", 0, an / 2], ["L", W / 2, 0], ["L", W, an / 2], ["L", W / 2, an], ["Z"]];
                ac = ao.path(aa)
            } else {
                if (z == "underline") {
                    aa = [["M", 0, an + Math.ceil(G / 2)], ["l", W, 0]];
                    ac = ao.path(aa).stroke({
                        width: G,
                        color: Q
                    })
                } else {
                    if (z == "bubbleRound") {
                        aa = [["M", 0, an / 2], ["A", W / 2, an / 2, 0, 0, 1, W / 2, 0], ["A", W / 2, an / 2, 0, 1, 1, 0, an / 2], ["Z"], ["M", 0, an], ["L", W / 4, an / 2], ["H", W / 4 * 3], ["Z"]];
                        ac = ao.path(aa)
                    } else {
                        if (z == "bubbleRectangle") {
                            aa = [["M", 0, ae], ["a", at.concat(ae, -ae)], ["h", W - 2 * ae], ["a", at.concat(ae, ae)], ["v", an - 2 * ae], ["a", at.concat(-ae, ae)], ["h", -W + ae + 34], ["l", -34, 10], ["l", 10, -10], ["h", -10 + ae], ["a", at.concat(-ae, -ae)], ["z"]];
                            ac = ao.path(aa)
                        } else {
                            if (z == "roundRectangle") {
                                aa = [["M", 0, ae], ["a", at.concat(ae, -ae)], ["h", W - 2 * ae], ["a", at.concat(ae, ae)], ["v", an - 2 * ae], ["a", at.concat(-ae, ae)], ["h", -W + 2 * ae], ["a", at.concat(-ae, -ae)], ["z"]];
                                ac = ao.path(aa).stroke({
                                    width: parseInt(Y),
                                    color: au
                                })
        ...
        if (c) {
            ao.path(c).stroke({
                width: l.height(),
                color: l.css("background-color")
            });
            var aw = ao.group();
            aw.attr({
                transform: "translate(" + ai + " " + Z + ")"
            });
            aw.path("M0 7A7 7 0 0 1 7 0A7 7 0 1 1 0 7Z").fill("#fff");
            aw.path(d).fill("#7C8084")
        }
        ac.fill(ay.color).opacity(ay.opacity);
        var X = ao.group().attr("transform", "translate(" + (v + J.find(".topic_icon_box").width()) + " " + s + ")");
        var I = X.group().attr("transform", "translate(0 " + ab + ")");
        ...
        if (J.find(".tp_extend_item.note")[0]) {
            var A = J.find(".tp_extend_item.note");
            this.createIcon(X, "note", A)
        }
        if (J.find(".tp_extend_item.link")[0]) {
            var k = J.find(".tp_extend_item.link");
            this.createIcon(X, "link", k, r)
        }
        if (J.find(".topic_icon_box")[0]) {
            var ap = J.children(".topic_icon_box").children(".topic_ico");
            for (var al = ap.length - 1; al >= 0; al--) {
                var u = ap.eq(al);
                var ah = u.attr("n");
                if (!ah) {
                    ah = "ico" + u.attr("index")
                }
                this.createIcon(X, ah, u)
            }
        }
        if (J.find(".tp_task")[0]) {
            I = X.group().attr("transform", "translate(" + (-J.find(".topic_icon_box").width()) + " " + (ab + b + av) + ")");
            f = "middle";
            T = J.find(".tp_task").width() / 2;
            I.text(function(a) {
                a.plain(J.find(".tp_task").text())
            }).fill(O).font({
                family: M + ",宋体",
                size: F,
                weight: E,
        ...
        if (J.siblings(".topic_tag")[0]) {
            var K = J.siblings(".topic_tag");
            var ak = this.getStyle(K);
            var af = ao.group().attr("transform", "translate(" + (W / 2 + K.css2num("margin-left")) + " " + an + ")");
            at = [ak.bdr, ak.bdr, 0, 0, 1];
            if (ak.bdr >= 0) {
                aa = [["M", 0, ak.bdr], ["a", at.concat(ak.bdr, -ak.bdr)], ["h", ak.w - 2 * ak.bdr], ["a", at.concat(ak.bdr, ak.bdr)], ["v", ak.h - 2 * ak.bdr], ["a", at.concat(-ak.bdr, ak.bdr)], ["h", -ak.w + 2 * ak.bdr], ["a", at.concat(-ak.bdr, -ak.bdr)], ["z"]]
            } else {
                aa = [["M", 0, 0], ["H", ak.w], ["L", ak.h], ["H", 0], ["Z"]]
            }
            af.path(aa).fill(ak.bgc.color).opacity(ak.bgc.opacity);
            I = af.group().attr("transform", "translate(" + ak.pl + " 0)");
            f = "middle";
            T = ak.w / 2 - ak.pl;
            I.text(function(a) {
                a.plain(ak.str)
        ...
        if (ax == "centerTopic") {
            ...
            o = $(".sub_linker_canvas[fortp='" + P + "']")
        }
        $.each(o, function(az, aE) {
            var h = $(aE);
            var w = des.utils.getRelativePos(h.offset().left + 5, h.offset().top + 5, $("#canvas"));
            var aC = w.x - $("#canvas").width() / 2;
            var aA = w.y - $("#canvas").height() / 2;
            var x = h.width() - 8;
            var a = h.height() - 8;
            var g = ["M"], n, aD, aB, p;
            if (aC - 5 <= j) {
            ...
            if (H == "straight") {
                ...
                if (H == "broken") {
                    aa = [g, ["l"].concat(n), ["L"].concat(p)]
                } else {
                    if (H == "roundBroken") {
                        aa = [g, ["l"].concat(n[0], n[1] - aD[2]), ["a", 10, 10, 0, 0].concat(aD), ["L"].concat(p)]
                    } else {
                        aa = [g, ["C"].concat(aB[0], aB[1], p)]
                    }
                }
            }
            N.path(aa).fill("none").stroke({
                width: G,
                color: Q
            })
        })
    },
    line2svg: function(e, v, D) {
        var n, m, l, j, L;
        n = v.start;
        m = v.end;
        l = v.points[0];
        j = v.points[1];
        L = v.styles;
        var C = [["M", y(n.x), y(n.y)], ["C", y(l.x), y(l.y), y(j.x), y(j.y), y(m.x), y(m.y)]];
        var M = e.group();
        var E = M.path(C).fill("none").stroke({
            width: L.lineWidth,
            color: L.lineColor,
            dasharray: (L.lineType == "dashed" ? [20, 20] : ["none"])
        });
        var I = L.lineWidth * 1 + 4;
        E.marker("start", I, I, function(c) {
            var a = I / 2;
            C = [["M", 0, a], ["A", a, a, 0, 0, 1, a, 0], ["A", a, a, 0, 1, 1, 0, a]];
            c.path(C).fill(L.lineColor);
            this.attr("markerUnits", "userSpaceOnUse")
        });
        I = L.lineWidth * 1 + 8;
        E.marker("end", I, I, function(a) {
            C = [["M", I, I / 2], ["l", -I, I / 2], ["l", 0, -I], ["z"]];
            a.path(C).fill(L.lineColor);
            this.attr({
        ...
        var z = $("#" + D + " .connection_textarea");
        if (!z[0]) {
            return
        }
        var q = des.utils.getRelativePos(z.offset().left, z.offset().top, $("#canvas"));
        var F, O, H, d, K, u, P, k, N, o, B, A, f, s, G;
        F = z.css2num("padding-top");
        O = z.css2num("padding-left");
        H = z.css2num("padding-right");
        d = z.css2num("padding-bottom");
        K = z.height() + F + d;
        u = z.width() + O + H;
        f = z.css2num("font-style");
        o = z.css2num("font-size");
        A = z.css2num("font-family");
        B = z.css2num("color");
        s = z.css2num("text-align");
        k = Export.getColor(z.css2num("background-color"));
        N = z.css2num("border-radius");
        G = z.val().split(/\n/);
        var Q = [N, N, 0, 0, 1];
        if (N > 0) {
            C = [["M", 0, N], ["a", Q.concat(N, -N)], ["h", u - 2 * N], ["a", Q.concat(N, N)], ["v", K - 2 * N], ["a", Q.concat(-N, N)], ["h", -u + 2 * N], ["a", Q.concat(-N, -N)], ["z"]]
        } else {
            C = [["M", 0, 0], ["h", u], ["v", K], ["h", -u], ["z"]]
        }
        var b = M.group().attr("transform", "translate(" + y(q.x) + " " + y(q.y) + ")").fill(k.color).opacity(k.opacity);
        b.path(C);
        z = b.group();
    ...
    createIcon: function(j, n, t, u) {
        var d, s, f, p, b, a, m, q;
        d = t.css2num("margin-left");
        s = t.parent().css2num("padding-top");
        f = t.height();
        p = t.width();
        q = $(".dock_content.dock_icons");
        var c = t.siblings().length + 1;
        var e = t.index();
        var k = Export.ico[n];
        var o = this.getRect(j);
        if (n == "link") {
            a = t.attr("href");
            if (u == "svg") {
                b = j.link(a).target("_blank")
            } else {
                b = j.group()
            }
        } else {
        ...
        var r = [["M", 0, p / 2], ["a", p / 2, p / 2, 0, 0, 1, p / 2, -p / 2], ["a", p / 2, p / 2, 0, 1, 1, -p / 2, p / 2]];
        if (n == "link" || n == "note") {
            b.attr({
                transform: "translate(" + (o.width + d) + " " + s + ")"
            }).style("cursor", "pointer").path(r).fill(k.color);
            b.path(k.path).fill("#fff").attr({
                transform: "translate(" + k.x + " " + k.y + ")"
            })
        } else {
            if (n == "priority") {
                m = q.children(".dock_ico[ico='" + t.attr("index") + "']").index() + 1;
                b.attr({
                    transform: "translate(" + (p * (e - c)) + " " + s + ")"
                }).style("cursor", "pointer").path(k.path).fill(k.color).attr({
                    transform: "translate(" + k.x + " " + k.y + ")"
                });
                b.group().attr("transform", "translate(" + 3 + " " + 3 + ")").text(function(g) {
                    g.plain(m)
                }).fill("#fff").font({
                    family: "黑体",
                    size: 20,
                ...
                if (n == "face") {
                    ...
                    b.attr({
                        transform: "translate(" + (p * (e - c)) + " " + s + ")"
                    }).style("cursor", "pointer").path(Export.ico.box).fill("#000");
                    b.path(k.path[m]).fill(k.color).attr({
                        transform: "translate(" + k.x + " " + k.y + ")"
                    })
                } else {
                    if (n == "completion") {
                        ...
                        b.attr({
                            transform: "translate(" + (p * (e - c)) + " " + s + ")"
                        }).style("cursor", "pointer").path(Export.ico.box).fill("#fff");
                        b.path(k.path[m]).fill(k.color).attr({
                            transform: "translate(" + k.x + " " + k.y + ")"
                        })
                    } else {
                        if (n == "flag") {
                            ...
                            b.attr({
                                transform: "translate(" + (p * (e - c)) + " " + s + ")"
                            }).style("cursor", "pointer").path(k.path).fill(k.color[m]).attr({
                                transform: "translate(" + k.x + " " + k.y + ")"
                            })
                        } else {
                            if (n == "arrow") {
                                ...
                                b.attr({
                                    transform: "translate(" + (p * (e - c)) + " " + s + ")"
                                }).style("cursor", "pointer").path(k.path[m]).fill(k.color).attr({
                                    transform: "translate(" + k.x + " " + k.y + ")"
                                })
                            } else {
                                b.attr({
                                ...
                                b.path(k.path).fill(k.color).attr({
                                    transform: "translate(" + k.x + " " + k.y + ")"
                                })
                            }
                        }
    ...
    getStyle: function(e) {
        var f, d, i, b, a, c, g;
        g = des.utils.getRelativePos(e.offset().left, e.offset().top, $("#canvas"));
        f = e.css2num("padding-top");
        d = e.css2num("padding-left");
        i = e.css2num("padding-right");
        b = e.css2num("padding-bottom");
        c = e.height() + f + b;
        a = e.width() + d + i;
        return {
            fst: e.css2num("font-style"),
            fs: e.css2num("font-size"),
            fw: e.css2num("font-weight"),
            ff: e.css2num("font-family"),
            fc: e.css2num("color"),
            ta: e.css2num("text-align"),
            pt: f,
            pl: d,
            pr: i,
            pb: b,
            h: c,
            w: a,
            left: g.x - $("#canvas").width() / 2,
            top: g.y - $("#canvas").height() / 2,
            str: e.text(),
            bgc: Export.getColor(e.css("background-color")),
            bdc: e.css2num("border-color"),
            bdw: e.css2num("border-width"),
            bdr: this.getRadius(a, c)
        }
    },
    getRect: function(c) {
        var b = c[0] || c.node || c;
...
Export.flow = {
    shape2svg: function(b, t, d) {
        var D, J, A, z = b.path, E, F, u, f, H, a;
        J = t.attr({
            transform: "translate(" + b.x + " " + b.y + ")"
        }).opacity(b.shape && b.shape.alpha ? b.shape.alpha : 1);
        for (var I = 0; I < z.length; I++) {
            ...
            D = {
                ...
                dashed: [f * 5, f * 2],
                dot: [f, f * 1.5],
                dashdot: [f * 5, f * 2, f, f * 2]
            };
            A = J.path(F.actions).stroke({
                width: f,
                color: u.lineColor.color,
                dasharray: D[u.lineStyle]
            });
            if (H && H.type) {
                E = this.getFill(b, H, J, A)
            }
            if (E) {
                if (E.node) {
                    A.fill(E)
                } else {
                    A.fill(E.color).opacity(E.opacity)
                }
            }
        }
        if (b.markers) {
        ...
        if (b.attrs) {
            for (var I = 0; I < b.attrs.length; I++) {
                var M = J.group();
                var C = b.attrs[I]
                  , v = "Microsoft Yahei"
                  , k = 13
                  , y = C.type == "link" ? "#72ACE3" : "#000"
                  , h = k * 1.25;
                if (C.type == "link" && d == "svg") {
                    M.link("http://" + C.value).attr("transform", "translate(" + C.x + " " + C.y + ")").fill("#fff")
                } else {
                    M.attr("transform", "translate(" + C.x + " " + C.y + ")").fill("#fff")
                }
                if (C.showType != "icon") {
                    var s = C.w / 2;
                    M.text(function(g) {
                    ...
                    this.convertImgToBase64(location.origin + C.icon, function(g) {
                        M.image(g).loaded(function(i) {
        ...
        if (b.strs) {
            for (var I = 0; I < b.strs.length; I++) {
                ...
                var B = b.strs[I]
                  ...
                  , c = w.italic
                  , o = w.underline
                  , h = k * 1.25 * n.txt.length;
                if (n.rotate) {
                    r.attr("transform", "matrix(0 -1 1 0 " + ((n.h - h) / 2 + n.x) + " " + n.y + ")").fill("#fff")
                } else {
                    if (w.vAlign == "top") {
                        r.attr("transform", "matrix(1 0 0 1 " + n.x + " 1)").fill("#fff")
                    } else {
                        if (w.vAlign == "bottom") {
                            r.attr("transform", "matrix(1 0 0 1 " + n.x + " " + (n.h - 20 + n.y) + ")").fill("#fff")
                        } else {
                            r.attr("transform", "matrix(1 0 0 1 " + n.x + " " + ((n.h - h) / 2 + n.y) + ")").fill("#fff")
                        }
                    }
                }
                for (var G = 0; G < n.txt.length; G++) {
                    var s = 0
                      , l = "start";
                    var L = k * 0.25;
                    if (q == "center") {
    ...
    flowline2svg: function(b, l, q) {
        var s, w = b.path, C = b.points, r = b.line, g = r.beginArrowStyle, e = r.endArrowStyle, a, u = b.font, f = r.lineWidth, A = {
            solid: ["none"],
            dashed: [f * 5, f * 2],
            dot: [f, f * 1.5],
            dashdot: [f * 5, f * 2, f, f * 2]
        };
        var y = q.path(w.actions).stroke({
            width: f,
            color: r.lineColor.color,
            dasharray: A[r.lineStyle]
        }).fill("none");
        if (g && g != "none") {
            y.marker("start", this.getMarkerArrow(r, l, true)[g]())
        }
        if (e && e != "none") {
            y.marker("end", this.getMarkerArrow(r, l)[e]())
        }
        if (w.text.length) {
            a = this.getRect(y),
            b.w = a.width,
            ...
            var n = u.textAlign
              ...
              , c = u.italic
              , m = u.underline
              , h = j * 1.25 * w.text.length;
            s = q.group().attr("transform", "matrix(1 0 0 1 " + C.mid.x + " " + (C.mid.y - h / 2) + ")");
            var E = s.path().fill("#fff");
            for (var B = 0; B < w.text.length; B++) {
                var z = w.text[B];
                var D = j * 1.25
                  , k = "middle"
                  , o = 0;
            ...
            a = this.getRect(s);
            _path = [["M", 0, 0], ["H", a.width], ["V", a.height], ["H", 0], ["V", 0], ["Z"]];
            E.plot(_path).attr("transform", "translate(" + -a.width / 2 + " 0)")
        }
    },
    json2path: function(props, paths, line, fill) {
        var path, pathArr = [], lineStyle, fillStyle, l, f, actions, action, hex, c1, c2, r, g, b, lineWidth, w = props.w, h = props.h, x = props.x, y = props.y;
        for (var i = 0; i < paths.length; i++) {
            path = [],
            l = $.extend({}, line),
            f = $.extend({}, fill),
            lineStyle = $.extend({}, paths[i].lineStyle),
            fillStyle = $.extend({}, paths[i].fillStyle),
            actions = paths[i].actions;
            if (fillStyle && fillStyle.type == "none") {
                f = {
                    type: "none"
                }
            } else {
                if (fillStyle && /^r-/.test(fillStyle.color)) {
                    hex = Export.getRGB(fill.color.color);
                    c1 = hex.replace(/rgb|\(|\)|\s/gi, "").split(","),
                    c2 = fillStyle.color.replace(/\s/g, "").split(","),
                    r = c1[0],
                    g = c1[1],
                    b = c1[2];
                    fillStyle.color = [eval(c2[0]), eval(c2[1]), eval(c2[2])].join(",");
                    f = $.extend(f, fillStyle)
                } else {
                    f = $.extend(f, fillStyle)
                }
            }
            lineWidth = l.lineWidth;
            lineStyle.lineWidth = eval(lineStyle.lineWidth);
            l = $.extend(l, lineStyle);
            if (l.lineColor) {
                l.lineColor = Export.getColor(l.lineColor)
            }
            for (var j = 0; j < actions.length; j++) {
                action = actions[j];
                path.push(this.toPath[action.action](w, h, x, y, action, l.lineWidth))
            }
            pathArr.push({
                actions: path,
                line: l,
    ...
    line2path: function(f) {
        var h = f.from, j = f.to, k = {}, p, l, a, m, o = f.lineStyle, c = f.linkerType, b = o.beginArrowStyle, d = o.endArrowStyle, g = {
            x: 0,
            y: 0,
            w: 0,
            h: 0
        ...
        if (f.points && f.points.length > 0) {
            for (var e = 0; e < f.points.length; e++) {
                ...
                k["p" + (e + 1)] = a = f.points[e]
            }
        }
        if (b && b != "none" && b != "normal" && b != "cross") {
            g = this.getMarkerArrow(o, null, b)[b]();
            k.from = h = Export.getMarkerPoint(h, l, g, c, true)
        }
        if (d && d != "none" && d != "normal" && d != "cross") {
            n = this.getMarkerArrow(o)[d]();
            if (c == "normal") {
                k.to = j = Export.getMarkerPoint(h, j, n, c, false)
            } else {
                k.to = j = Export.getMarkerPoint(a, j, n, c, false)
            }
        }
        p = [["M", h.x, h.y]].concat(this.toPath[c](f.points, j)),
        k.mid = this.getPostOnLine[c](h, f.points, j, 0.5);
        return [{
            actions: p,
            text: f.text.split("\n")
        }, k]
    },
    marker2svg: function(j, l, g) {
        var a = [], o, e, b = j.markers, c = j.markerOffset, k = 4, f = Schema.config.markerSize, p = b.length * f + (b.length - 1) * k, n = l.w / 2 - p / 2, m = l.h - f - c, r = {
            lineColor: "50,50,50",
            lineStyle: "solid",
            lineWidth: 2,
        ...
        for (var d = 0; d < b.length; d++) {
            o = {},
            e = Schema.markers[b[d]].call(g, f),
            o.h = f,
            o.w = p,
            o.x = n,
            o.y = m,
            o.line = r,
            o.line.lineColor = Export.getColor(o.line.lineColor);
            o.fill = q;
            if (o.fill.alpha != 1) {
                o.fill.color += "," + o.fill.alpha
            }
            o.fill.color = Export.getColor(o.fill.color);
            o.path = this.json2path({
                w: p,
                h: f,
                x: n,
                y: m
    ...
    attr2svg: function(g, m, b) {
        var f, l = [], d, j, k, e, a;
        for (var c = 0; c < m.length; c++) {
            d = m[c],
            f = {};
            if ((d.value || d.icon) && d.showType && d.showType != "none") {
                f.text = "",
                f.name = d.name,
                f.value = d.value,
                f.showType = d.showType,
                f.type = d.type,
                a = $("#attr_canvas_" + d.id);
                if (d.showName) {
                    f.text = d.name + "："
                ...
                if (d.icon) {
                    f.icon = "/images/data-attr/" + d.icon + ".png"
                }
                if (d.value) {
                    f.text += d.value
                }
    ...
    convertImgToBase64: function(d, e) {
    ...
    getMarkerArrow: function(s, o, b) {
        var a, k, e, p, j, g = b ? 180 : 0, q, c = s.lineWidth, f = c / 2, i = Math.PI, n = Export.getMarkerRect, m;
        return {
            normal: function() {
                var d = 12
                  , r = Math.PI / 5
                  , l = d * Math.tan(r);
                m = n.getArrowRect(r, l * 2, d, f);
                if (!o) {
                    return m
                }
                return o.marker(m.w, m.h, function(h) {
                    q = [["M", 0, 0], ["L", d, l], ["L", 0, l * 2]];
                    h.path(q).stroke({
                        color: s.lineColor.color,
                        width: c
                    }).fill("none").rotate(g, m.w / 2 + m.x, m.h / 2 + m.y);
                    this.attr({
                        markerUnits: "userSpaceOnUse",
                        viewBox: [m.x, m.y, m.w, m.h].join(" ")
                    })
                }).ref(m.x + (b ? 0 : m.w), l)
            },
            solidArrow: function() {
                ...
                j = p * Math.tan(arrowAngle);
                m = n.getTriRect(arrowAngle, j * 2, p, f);
                if (!o) {
                    return m
                }
                return o.marker(m.w, m.h, function(d) {
                    q = [["M", p, j], ["l", -p, j], ["v", -j * 2], ["z"]];
                    d.path(q).stroke({
                        color: s.lineColor.color,
                        width: c
                    }).fill(s.lineColor.color).rotate(g, m.w / 2 + m.x, m.h / 2 + m.y);
                    this.attr({
                        markerUnits: "userSpaceOnUse",
                        viewBox: [m.x, m.y, m.w, m.h].join(" ")
                    })
            ...
            dashedArrow: function() {
                ...
                return o.marker(m.w, m.h, function(d) {
                    ...
                    d.path(q).stroke({
                        color: s.lineColor.color,
                        width: c
                    }).fill("#fff").rotate(g, m.w / 2 + m.x, m.h / 2 + m.y);
                    this.attr({
                        markerUnits: "userSpaceOnUse",
                        viewBox: [m.x, m.y, m.w, m.h].join(" ")
                    })
            ...
            solidCircle: function() {
                ...
                return o.marker(outerW, outerW, function(d) {
                    q = [["M", 0, a], ["A", a, a, 0, 0, 1, a, 0], ["A", a, a, 0, 1, 1, 0, a]];
                    d.path(q).stroke({
                        color: s.lineColor.color,
                        width: c
                    }).fill(s.lineColor.color);
                    this.attr({
                        markerUnits: "userSpaceOnUse",
                        viewBox: [-f, -f, outerW, outerW].join(" ")
                    })
                }).ref(b ? k : 0, a)
            },
            ...
            solidDiamond: function() {
                p = 8,
                arrowAngle = Math.PI / 7,
                j = p / Math.tan(Math.PI / 2 - arrowAngle);
                m = n.getTriRect(arrowAngle, j * 2, p, f);
                m.x = -m.r,
                m.w = m.w * 2 - c;
                if (!o) {
                ...
                return o.marker(m.w, m.h, function(d) {
                    q = [["M", 0, j], ["L", p, 0], ["L", p * 2, j], ["L", p, j * 2], ["z"]];
                    d.path(q).stroke({
                        color: s.lineColor.color,
                        width: c
                    }).fill(s.lineColor.color);
            ...
            cross: function() {
                e = 14,
                j = 12,
                m = n.getDiagRect(e, j / 2, f);
                if (!o) {
                    return m
                }
                return o.marker(m.w, m.h, function(d) {
                    q = [["M", m.w + m.x * 2, 0], ["L", 0, j]];
                    d.path(q).stroke({
                        color: s.lineColor.color,
                        width: c
                    }).fill("none");
    ...
    getRotated: function(b, i, c) {
        var e = i.y - b.y;
        var g = i.x - b.x;
        var a = Math.sqrt(Math.pow(e, 2) + Math.pow(g, 2));
        if (a == 0 || c == 0) {
            return i
        }
        var f = Math.atan(Math.abs(i.x - b.x) / Math.abs(b.y - i.y));
        if (i.x >= b.x && i.y >= b.y) {
            f = Math.PI - f
        } else {
            if (i.x <= b.x && i.y >= b.y) {
    ...
    getFill: function(shape, fill, draw, path) {
        var h = shape.h
          , w = shape.w;
        if (fill.type == "none") {
            return {
            ...
            if (fill.type == "solid") {
                return Export.getColor(fill.color || "#fff")
            } else {
                if (fill.gradientType == "linear") {
                    ...
                    if (p.w > p.h) {
                        ...
                        angle = (fill.angle + Math.PI / 2) % (Math.PI * 2)
                    } else {
                        begin = {
                            x: p.w / 2,
                            y: 0
                    ...
                    if (angle != 0) {
                        ...
                        begin = this.getRotated(center, begin, angle);
                        end = this.getRotated(center, end, angle);
                        if (begin.x < 0) {
                            begin.x = 0
                        }
                        if (begin.x > shape.w) {
                    ...
                    return draw.gradient(fill.gradientType, function(stop) {
                        var bc = Export.getColor(fill.beginColor);
                        var ec = Export.getColor(fill.endColor);
                        stop.at({
                            offset: 0,
                            color: bc.color,
                            opacity: bc.opacity
                    ...
                    }).from(begin.x / p.w, begin.y / p.h).to(end.x / p.w, end.y / p.h)
                } else {
                    if (fill.gradientType == "radial") {
                        ...
                        if (fill.type == "image") {
                            var filePath = fill.fileId;
                            var cate = filePath.match(/andriod_icons|ios_icons/);
                            if (cate) {
                                var name = filePath.substring(filePath.lastIndexOf("/") + 1, filePath.lastIndexOf("."));
                                var icon = Export[cate[0]][name];
                                var pattern = draw.pattern(shape.w, shape.h, function(add) {
                                    var x = (shape.w - icon.width) / 2
                                      , y = (shape.h - icon.height) / 2;
                                    add.path(icon.path).fill(icon.color).translate(x, y)
                                });
                                path.fill(pattern);
                                return
                            }
                            cate = filePath.match(/\.svg/);
                            if (cate) {
                                return
                            }
                            var flag = /image/.test(filePath);
                            var url = flag ? location.origin + filePath : location.origin + "/file/id/" + filePath + "/diagram_user_image";
                            this.convertImgToBase64(url, function(img) {
                                var pattern = draw.pattern(shape.w, shape.h, function(add) {
                                    var x = parseInt(eval(fill.imageX))
                                      , y = parseInt(eval(fill.imageY))
                                      , imgW = fill.imageW || shape.w
                                      , imgH = fill.imageH || shape.h;
                                    if (fill.display == "fill") {
                                        if (shape.w / shape.h > imgW / imgH) {
                                            imgH = imgH * shape.w / imgW,
                                            imgW = shape.w
                                        } else {
                                            imgW = imgW * shape.h / imgH,
                                            imgH = shape.h
                                        }
                                    }
                                    x = typeof x == "number" && !isNaN(x) ? x : (shape.w - imgW) / 2;
                                    y = typeof y == "number" && !isNaN(y) ? y : (shape.h - imgH) / 2;
                                    add.image(img, imgW, imgH).move(x, y)
                                });
                                path.fill(pattern)
                            })
                        } else {
    ...
    textSplit: function(props, blocks, font) {
        var h, w, tw, div_temp, block, text = {}, post, f, width, val, lines, line, textTemp, lineBlock, lineBlocks = [], name = font.orientation;
        h = w = /horizontal/.test(name) ? props.h : props.w;
        for (var k = 0; k < blocks.length; k++) {
            block = blocks[k],
            f = $.extend(block.font, $.extend({}, font));
            post = block.position;
            if (/horizontal/.test(name)) {
                tw = eval(post.h)
            } else {
                tw = eval(post.w)
            }
            h = props.h,
            w = props.w,
            f = $.extend(f, block.fontStyle);
            div_temp = document.getElementById("area_div_temp");
            if (!div_temp) {
                div_temp = document.createElement("div");
                div_temp.setAttribute("id", "area_div_temp");
                document.body.appendChild(div_temp)
            }
            div_temp.style.opacity = 0;
            div_temp.style.visibility = "hidden";
            div_temp.style.display = "inline-block";
            div_temp.style.fontSize = f.size + "px";
            if (!block.text) {
                continue
            }
            val = block.text.replace(/\u00A0|\u0000/g, " ");
            lines = val.split(/\n/g);
            if (/horizontal/.test(name)) {
                lineBlock = {
                    x: eval(post.x),
            ...
            for (var i = 0; i < lines.length; i++) {
                line = lines[i];
                div_temp.innerHTML = "";
                div_temp.innerHTML = line;
                if (div_temp.offsetWidth + 10 > tw) {
                    div_temp.innerHTML = "";
                    textTemp = "";
                    for (var j = 0; j < line.length; j++) {
                        div_temp.innerHTML += line[j];
                        if (div_temp.offsetWidth + 10 <= tw) {
                            textTemp += line[j];
                            if (j == line.length - 1) {
                                lineBlock.txt.push(textTemp);
                                textTemp = "";
                                div_temp.innerHTML = ""
                            }
                        } else {
                            lineBlock.txt.push(textTemp + line[j]);
                            textTemp = "";
                            div_temp.innerHTML = ""
                        }
                    }
                } else {
                    lineBlock.txt.push(line);
                    textTemp = "";
                    div_temp.innerHTML = ""
                }
            }
    ...
    getPostOnLine: {
        curve: function(h, c, g, b) {
            var a, f, e = c[0], d = c[1];
            a = h.x * Math.pow((1 - b), 3) + 3 * e.x * b * (1 - b) * (1 - b) + 3 * d.x * b * b * (1 - b) + g.x * b * b * b,
            f = h.y * Math.pow((1 - b), 3) + 3 * e.y * b * (1 - b) * (1 - b) + 3 * d.y * b * b * (1 - b) + g.y * b * b * b;
            return {
                x: a,
                y: f
            }
        },
        broken: function(h, m, j, n) {
            var o = [], a, c = 0, e, d;
            function k(l, i) {
                if (l.x == i.x) {
                    return {
                        len: Math.abs(i.y - l.y),
                        hor: false,
                        right: i.y > l.y ? true : false
                    }
                }
                return {
                    len: Math.abs(i.x - l.x),
                    hor: true,
                    right: i.x > l.x ? true : false
                }
            }
            a = k(h, m[0]),
            c += a.len,
        ...
        normal: function(f, c, e, b) {
            var a, d;
            a = f.x + Math.abs((f.x - e.x) * b),
            d = f.y + Math.abs((f.y - e.y) * b);
            return {
                x: a,
                y: d
            }
    ...
    toPath: {
        move: function(w, h, x, y, a, lineWidth) {
            return ["M", eval(a.x), eval(a.y)]
        },
        line: function(w, h, x, y, a, lineWidth) {
            return ["L", eval(a.x), eval(a.y)]
        },
        quadraticCurve: function(w, h, x, y, a, lineWidth) {
            return ["Q", eval(a.x1), eval(a.y1), eval(a.x), eval(a.y)]
        },
        curve: function(w, h, x, y, a, lineWidth) {
            if (typeof w == "number" || typeof w == "string") {
                return ["C", eval(a.x1), eval(a.y1), eval(a.x2), eval(a.y2), eval(a.x), eval(a.y)]
            }
            return [["C", w[0].x, w[0].y, w[1].x, w[1].y, h.x, h.y]]
        },
        close: function(e, f, c, g, d, b) {
            return ["Z"]
        },
        broken: function(c, d) {
            var a = [];
            for (var b = 0; b < c.length; b++) {
                a.push(["L", c[b].x, c[b].y])
            }
            a.push(["L", d.x, d.y]);
            return a
        },
